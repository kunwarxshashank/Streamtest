...
export default function NetworkStreamPlayer() {
  ...
  const getEmbedCode = () => {
    ...
    switch (embedType) {
      case "iframe":
        return `<iframe src="https://streamtest.site?url=${encodeURIComponent(url)}${drmParams}" width="640" height="360" frameborder="0" allowfullscreen></iframe>`
      case "direct":
        return `https://streamtest.site?url=${url}`
      case "html":
              ...
              <CardContent className="space-y-3 sm:space-y-4 pt-0">
                ...
                <Tabs defaultValue="none" onValueChange={setDrmType}>
                  ...
                  <TabsContent value="clearkey" className="space-y-1 sm:space-y-2">
                    ...
                    <Textarea
                      id="clearkey"
                      placeholder='{ "keys":[ { "kty":"oct", "k":"zFzzt5KPueCh7mqLVm8Kjg", "kid":"F3nCe50HejugycwbualLnw" } ], "type":"temporary" }   or   e1e1fa75dadfdd82184aa2f1dd97af42:37f1b4f7507a6e89ebf2b8f4486d497e'
                      value={clearKeyData}
